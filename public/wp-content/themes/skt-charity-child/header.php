    ...
    <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slider3.jpg" alt="" title="#slidecaption3" />
      ...
      <div id="slidecaption1" class="nivo-html-caption">
        <div class="slide_info">
                ...
                <a class="ReadMore" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More!', 'skt-charity');?></a>
        </div>
        </div>
    ...
    <div class="container">                
            ...
            while( $queryvar->have_posts() ) : $queryvar->the_post(); ?> 
                <div class="one_four_page <?php if($fx % 4 == 0) { echo "last_column"; } ?>">
                 ...
                 <a class="more" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More!','skt-charity'); ?></a>
               </div>
             <?php endwhile;
             wp_reset_query();
             ?>
        ...
        <div class="one_four_page <?php if($fx % 4 == 0) { echo "last_column"; } ?>">
             ...
             <a class="more" href="<?php echo esc_url('#');?>"><?php esc_html_e('Read More!','skt-charity'); ?></a>
         </div>
        <?php }} ?>
      <div class="clear"></div>
    </div><!-- .container -->
       ...
       <section id="wrapfirst">
                <div class="container">
                    ...
                    <?php while( $queryvar->have_posts() ) : $queryvar->the_post();?>                     
                     ...
                     <h2><?php the_title(); ?></h2> 
                     <?php the_content(); ?> 
                     <a class="donatebtn" href="<?php the_permalink(); ?>"><?php _e('Read More!','skt-charity'); ?></a>                     <div class="clear"></div>
                    <?php endwhile; } else { ?>                   
...
Suspendisse lobortis pellentesque orci, in sodales nisi pretium sit amet. Aenean vulputate, odio non euismod eleifend, magna nisl elementum lorem, ac venenatis nunc erat et metus. Nulla volutpat urnaeu tellus odio hendrerit nibh. ','skt-charity'); ?></p> 
                    <a class="donatebtn" href="<?php echo esc_url('#');?>"><?php _e('Read More!','skt-charity'); ?></a>                    <?php } ?>
               </div><!-- welcomewrap-->
              <div class="clear"></div>
            </div><!-- container -->
